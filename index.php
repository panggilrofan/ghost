...
?>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <h2>Semoga dengan adanya Hello Farm dapat membantu para peternak</h2>
      ...
      <div class="container">
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <h2 class="title">Hello Farm</h2>
            <p>
              Hello Farm adalah sebuah website yang ditujukan untuk membantu para peternak dalam mengatasi penyakit yang diderita oleh hewan ternaknya. Kami juga membantu untuk menyebuhkan hewan ternak tersebut hingga pulih kembali.
            </p>

            <div class="icon-box wow fadeInUp">
              <div class="icon"><i class="fa fa-shopping-bag"></i></div>
              <h4 class="title"><a href="">Toko</a></h4>
              <p class="description">Disini, kami melayani pembelian obat - obatan untuk penyakit hewan ternak</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-file-text-o"></i></div>
              <h4 class="title"><a href="">Artikel</a></h4>
              <p class="description">Disini, kami menyediakan artikel tentang penyakit dan pakan hewan ternak</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
              <div class="icon"><i class="fa fa-commenting-o"></i></div>
              <h4 class="title"><a href="">Konsultasi Kesehatan Hewan Ternak</a></h4>
              <p class="description">Disini, kami menerima konsultasi penyakit hewan ternak melalu livechat yang tersedia</p>
            </div>
    ...
    <section id="portfolio">
      <div class="container wow fadeInUp">
        <div class="section-header">
          ...
          <p class="section-description">2 fitur yaitu, artikel dan toko</p>
        </div>
        <div class="row">

          <div class="col-lg-12">
            <ul id="portfolio-flters">
              <li data-filter=".filter-app, .filter-web" class="filter-active">Semua</li>
              <li data-filter=".filter-app">Artikel</li>
              <li data-filter=".filter-web">Toko</li>
            </ul>
          </div>
        </div>
