...
<?php
  include("koneksi.php");
  $id = $_GET['id'];
  $qrySelect = mysqli_query($koneksi, "select *from artikel where id_artikel = '$id'");
  $dataArtikel = mysqli_fetch_array($qrySelect);
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../../index.php" class="logo">
      ...
      <span class="logo-lg"><b>Hello</b>Farm</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Kamu memiliki 0 pesan</li>
              <li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Kamu memiliki 0 notifikasi</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                </ul>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Kamu memiliki 0 tugas</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                </ul>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $_SESSION['pengguna']; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../artikel.php"><i class="fa fa-circle-o"></i> Artikel Aktif</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <form method="post" action="prosesEditArtikel.php" enctype="multipart/form-data">
                <div class="form-group mt-3" style="width:50%;" hidden>
                  <input type="text" name="id" class="form-control" value="<?php echo $id; ?>">
                </div>
                <div class="form-group mt-3" style="width:50%;">
                  <input type="text" name="judul" class="form-control" placeholder="Judul Artikel" value="<?php echo $dataArtikel['judul_artikel']; ?>">
                </div>

                <div class="form-group mt-3" style="width:60%;">
                <textarea name="artikel" id="editor" rows="8" cols="80"><?php echo $dataArtikel['isi_artikel']; ?></textarea>
                </div>
