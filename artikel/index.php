          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="single-blog">
                ...
                <div class="blog-text">
                  <h4>
                      <a href="showArtikel.php?id=<?php echo $data['id_artikel']; ?>"><?php echo $data['judul_artikel']; ?></a>
                  </h4>
                  <p>
                  <?php
                  ...
                  <span>
                    <a href="showArtikel.php?id=<?php echo $data['id_artikel']; ?>" class="ready-btn">Read more</a>
                  </span>
                </div>
              </div>
            <?php }?>
